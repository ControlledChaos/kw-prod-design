	...
	<div class="dashboard-panel-column-container">
		...
		<div class="dashboard-panel-column dashboard-panel-last">
			...
			<ul>
				...
				<li><a class="dashboard-icon customize-icon-typography" href="<?php echo esc_url( wp_customize_url() . '?url=' . site_url() . '&autofocus[section]=typography_options&return=' . site_url() ); ?>"><?php _e( 'Design your typography', 'kw-prod-design' ); ?></a></li>
				<li><a class="dashboard-icon customize-icon-background" href="<?php echo esc_url( wp_customize_url() . '?url=' . site_url() . '&autofocus[section]=background_image&return=' . site_url() ); ?>"><?php _e( 'Site background', 'kw-prod-design' ); ?></a></li>
